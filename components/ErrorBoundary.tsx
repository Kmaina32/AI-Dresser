...
// Fixed: Explicitly importing and extending Component with generic parameters.
// This ensures that 'this.props' and 'this.state' are correctly recognized by the TypeScript compiler.
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  // Added constructor to properly initialize the base class with props and set the initial state.
