...
export const getLogoSvgDataUrl = (imageWidth: number): string => {
    ...
    const svgString = `
      <svg width="${logoWidth}" height="${logoHeight}" xmlns="http://www.w3.org/2000/svg">
        <style>
          .logo-text { font-family: 'Space Grotesk', serif; font-size: ${fontSize}px; }
          .logo-geo { fill: rgba(255, 255, 255, 0.9); }
          .logo-studio { fill: rgba(161, 161, 170, 0.9); }
          .icon-path { stroke: rgba(245, 158, 11, 0.9); fill: none; }
          .icon-pupil { fill: rgba(245, 158, 11, 0.9); }
        </style>
        <g transform="translate(0, ${ (logoHeight - iconSize) / 2}) scale(${iconSize / 24})">
            <path class="icon-path" d="M19.9999 12C19.9999 16.4183 16.4182 20 11.9999 20C7.58163 20 3.9999 16.4183 3.9999 12C3.9999 7.58172 7.58163 4 11.9999 4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path class="icon-path" d="M12 12H20" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
