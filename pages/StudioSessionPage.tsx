                ...
                {/* Mobile Sidebar Header */}
                 <div className="flex items-center justify-between p-5 border-b border-white/5 lg:hidden bg-zinc-950/80 backdrop-blur-md relative z-20 shadow-2xl">
                    <div className="flex items-center gap-3">
                         ...
                         <span className="font-playfair text-xl text-white font-bold tracking-wide">Session Setup</span>
                    </div>
                    <button 
                        onClick={() => setIsSidebarOpen(false)} 
                ...
                {/* Scrollable Controls */}
                 <div className="flex-grow overflow-y-auto custom-scrollbar pb-32 lg:pb-0">
                    <div className="p-6 space-y-6">
                        ...
                        <div className="px-4 py-3 bg-zinc-900/50 border border-amber-500/30 rounded-sm flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                                <LockClosedIcon className="w-4 h-4 text-amber-400" />
                                <span className="text-xs font-bold text-amber-400 uppercase tracking-widest">Identity & Physique Lock</span>
                            </div>
                            <p className="text-[10px] text-zinc-500 pl-6">AI is instructed to strictly maintain facial features and body build.</p>
                        </div>
                    </div>
                 ...
                 <div className="w-full max-w-3xl animate-fade-in">
                    ...
                    {!generatedImage && !isLoading && (
                         <div className="text-center mt-8 opacity-50">
                            <UsersIcon className="w-16 h-16 mx-auto text-zinc-700 mb-4" />
